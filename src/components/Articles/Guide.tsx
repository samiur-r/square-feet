    ...
    <div className="bg-primary py-10 w-full">
      <div className="dir-rtl container max-w-6xl">
        ...
        <div className="text-white text-sm md:text-lg dir-rtl">
          <div>
            بوشملان هو دليل الكويت العقاري الأول والاكبر والأكثر شهرة في الكويت
            ودول الخليج العربي وفيه تجد الإعلانات الخاصة بعقارات الكويت بمختلف
            أنواعها. نساعدك بالبحث عن{' '}
          ...
          <div>
            ...
            او كنت دلال او وسيط عقاري وتحاول عقد صفقات عقارية، فإن زيارتك لدليل
            عقارات الكويت هي الخطوة الأولى لتحقيق هدفك بسرعه وبسهوله، فنحن نقدم
            الحلول العقارية بشكل متطور وحديث على شكل موقع الكتروني وكذلك تطبيق
            موبايل متوفر على اجهزة{' '}
          ...
          <div>
            ...
            ولسنا وسيط عقاري ولا نتدخل بأي شكل من الاشكال بين البائع والمشتري من
            استفسارات او مفاوضات واتفاقيات. ولا نتقاضى أي عمولة أو رسوم على
          ...
          <div>
            يمكنك كذلك إضافة إعلانك مجانًا لدينا من خلال التسجيل معنا بشكل مجاني
            ايضا ، ويجب عليك تأكيد حسابك عن طريق رسالة نصية SMS وبعدها ستتمكن من
            إضافة إعلانك وتحديد البيانات التاليه: الموبايل، المنطقة، نوع العقار،
            الغرض من الإعلان سواء كان{' '}
            <Link href="/للايجار">
              <a className="underline underline-offset-4">للايجار</a>
            </Link>{' '}
            او{' '}
            ...
            الغرف وعدد الصالات والحمامات، والأدوار، وعدد المصافط المتوفرة، وتوفر
            الاصنصير (المصعد)، ونوعية التشطيب مثل سوبر ديلوكس او بنيان قديم،
            وكذلك يمكنك بشكل اختياري إضافة صور العقار مع الإعلان.
          </div>
          <div>
