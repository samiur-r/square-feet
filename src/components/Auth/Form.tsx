    ...
    <form className="w-full mt-10 md:px-auto dir-rtl">
      ...
      <div className="mt-5">
        {type === 'register' ? (
          <button
            type="submit"
            className="bg-secondary w-full hover:opacity-90 transition-opacity duration-300 text-white font-DroidArabicKufiBold font-bold py-3.5 md:py-4 px-8 rounded-lg"
          >
            تسجيل
          </button>
        ) : (
