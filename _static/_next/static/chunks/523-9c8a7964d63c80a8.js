;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [523, 578],
  {
    8453: function (e, t, r) {
      let a = r(959),
        s = a.forwardRef(function ({ title: e, titleId: t, ...r }, s) {
    ...
    638: function (e, t, r) {
      ...
      var a = r(7135),
        ...
        C = function (e) {
          var t = e.isArchive,
            r = e.isSticky,
            a = e.isCallingApiForStick,
            s = e.isCallingApiForRepost,
            i = e.isCallingApiForDelete,
            l = e.handleAction
          return (0, n.jsxs)('div', {
            className: 'flex flex-row-reverse gap-3',
            children: [
              (0, n.jsx)('div', {
                className: 'p-1 bg-[#ECEEF0] rounded-md flex items-center',
                children: i
                  ? (0, n.jsxs)('svg', {
                      'aria-hidden': 'true',
                      role: 'status',
                      className:
                        'inline w-5 h-5 mr-0 text-primary animate-spin',
                      viewBox: '0 0 100 101',
                      fill: 'none',
                      xmlns: 'http://www.w3.org/2000/svg',
                      children: [
              ...
              !t &&
                (0, n.jsx)('div', {
                  className: 'p-1 bg-[#FBE4DB] rounded-md',
                  children: (0, n.jsx)(v, {
              ...
              !r &&
                !t &&
                (0, n.jsx)('div', {
                  className: 'p-1 bg-[#F8D8D7] rounded-md flex items-center',
                  children: a
                    ? (0, n.jsxs)('svg', {
                        'aria-hidden': 'true',
                        role: 'status',
              ...
              t &&
                (0, n.jsx)('div', {
                  className: 'p-1 bg-[#E3F4F1] rounded-md flex items-center',
                  children: s
                    ? (0, n.jsxs)('svg', {
                        'aria-hidden': 'true',
                        role: 'status',
        ...
        g = function (e) {
          var t,
            ...
            _ = (
              null == x
                ? void 0
                : null === (t = x.media) || void 0 === t
                ? void 0
                : t.length
            )
              ? '/images/posts/'.concat(x.media[0])
              : '/images/nopic-ar.jpg',
            B = (0, c.Z)(
              null == x
                ? void 0
                : null === (r = x.updated_at) || void 0 === r
                ? void 0
                : r.toString()
            ),
            R = B.unit,
              ...
              ((f = (0, a.Z)(function (e) {
                return (0, s.__generator)(this, function (t) {
                  switch (t.label) {
                    ...
                    case 1:
                      return (
                        u().push('/post?mode=edit&id='.concat(x.id)), [3, 9]
                      )
                    case 2:
                      return [4, F()]
                    case 3:
          ...
          return (0, n.jsxs)('div', {
            className: ''
              ...
              .concat(
                g ? 'bg-custom-gray-3' : 'shadow-md bg-white',
                '\n      rounded-lg border cursor-pointer mt-3 py-2.5 px-2.5 relative'
              ),
            children: [
              (0, n.jsxs)('div', {
                className: 'flex md:items-center gap-3 md:gap-4',
                children: [
                  (0, n.jsx)('div', {
                    className:
                      'rounded-lg overflow-hidden h-full w-full max-w-fit flex items-center border',
                    children: (0, n.jsx)('div', {
                      className: 'w-16 h-12 md:w-28 md:h-28 relative',
                      children: (0, n.jsx)(o(), {
                        src: _,
                        layout: 'fill',
                        objectFit: 'cover',
                  ...
                  (0, n.jsxs)('div', {
                    children: [
                      (0, n.jsx)('div', {
                        className:
                          'font-DroidArabicKufiBold text-sm md:text-lg line-clamp-1 max-w-xs',
                        children: x.title
                      }),
                      (0, n.jsxs)('div', {
                        className: 'flex gap-3 md:gap-5 mt-3',
                        children: [
                          (0, n.jsxs)('div', {
                            className:
                              'text-primary md:text-base text-xs font-bold font-DroidArabicKufiBold',
                            children: [x.price, ' دك']
                          }),
                          (0, n.jsxs)('div', {
                            ...
                            children: [
                              ...
                              (0, n.jsx)('div', {
                                className:
                                  'text-custom-gray md:text-base text-xs',
                                children: ''.concat(D, ' ').concat(R)
                              })
                            ]
                          }),
                          (0, n.jsxs)('div', {
                      ...
                      (0, n.jsx)('div', {
                        className:
                          'hidden md:block mt-3 text-sm text-custom-gray-1 md:line-clamp-2',
              ...
              (0, n.jsx)('div', {
                className:
                  'md:hidden mt-3 text-xs text-custom-gray-1 line-clamp-2',
                children: x.description
              }),
              v &&
                (0, n.jsx)('div', {
                  className:
                    'mt-5 md:mt-3 w-full grid place-items-center md:absolute md:top-0 md:place-items-end md:pl-10',
                  children: (0, n.jsx)(C, {
                    isArchive: g,
                    isSticky: x.is_sticky,
                    isCallingApiForStick: E,
                    isCallingApiForRepost: A,
                    isCallingApiForDelete: M,
                    handleAction: O
                  })
                })
            ]
    ...
    3096: function (e, t, r) {
      ...
      var a,
        ...
        i = {
          nodeEnv:
            null !== (a = n.env.NEXT_PUBLIC_NODE_ENV) && void 0 !== a
              ? a
              : 'development',
          port: null !== (s = n.env.NEXT_PUBLIC_PORT) && void 0 !== s ? s : 3e3,
          domain: n.env.DOMAIN,
    ...
    2578: function (e, t, r) {
      'use strict'
      var a = r(8086),
        s = r(3096).Z.apiUrl || 'http://localhost:5000/api/v1'
      t.Z = a.Z.create({ withCredentials: !0, baseURL: s })
    },
    9277: function (e, t) {
      'use strict'
      var r = function (e) {
        ...
        var t = new Date(Date.parse(e)),
          r = new Date(Date.now()).getTime() - t.getTime(),
          a = Math.floor(r / 864e5),
          s = Math.floor((r / 36e5) % 24),
          n = '',
          i = 0
        return (
          a >= 1
            ...
            : s >= 1
            ? ((n = 'ساعة'), (i = s))
            : ((n = 'دقيقة'), (i = Math.floor((r / 6e4) % 60))),
          { unit: n, timeElapsed: i }
        )
      }
      t.Z = r
    }
